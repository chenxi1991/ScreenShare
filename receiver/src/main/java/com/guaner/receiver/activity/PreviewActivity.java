package com.guaner.receiver.activity;
...
import com.guaner.receiver.R;
import com.guaner.receiver.player.Player;
...
public class PreviewActivity extends AppCompatActivity {
    ...
    private SurfaceHolder.Callback mEncoderCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            ...
            mPlayer = new Player(49152, surfaceHolder.getSurface(), 1280, 720);
